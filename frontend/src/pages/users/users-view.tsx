    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Investments Investor</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.investments_investor &&
                      Array.isArray(users.investments_investor) &&
                      users.investments_investor.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.investments_investor?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
