    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Investments organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.investments_organization &&
                      Array.isArray(organizations.investments_organization) &&
                      organizations.investments_organization.map(
                        (item: any) => (
                          <tr
                            key={item.id}
                            onClick={() =>
              ...
              {!organizations?.investments_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Startups organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.startups_organization &&
                      Array.isArray(organizations.startups_organization) &&
                      organizations.startups_organization.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
                              `/startups/startups-view/?id=${item.id}`,
                            )
                          }
                        >
              ...
              {!organizations?.startups_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
