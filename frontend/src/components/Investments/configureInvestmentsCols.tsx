...
export const loadColumns = async (
  ...
  const hasUpdatePermission = hasPermission(user, 'UPDATE_INVESTMENTS');

  return [
    {
      field: 'amount',
      headerName: 'InvestmentAmount',
      flex: 1,
      minWidth: 120,
      filterable: false,
...

    {
      ...
      valueOptions: await callOptionsApi('startups'),
