...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/startups/startupsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureStartupsCols';
...
const TableSampleStartups = ({ filterItems, setFilterItems, filters }) => {
  ...
  const {
    ...
    loading,
    count,
    notify: startupsNotify,
    refetch,
  } = useAppSelector((state) => state.startups);
  ...
  useEffect(() => {
    if (startupsNotify.showNotification) {
      notify(startupsNotify.typeNotification, startupsNotify.textNotification);
    }
  }, [startupsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/startups/startups-view/?id=${id}`);
  };
...
export default TableSampleStartups;
