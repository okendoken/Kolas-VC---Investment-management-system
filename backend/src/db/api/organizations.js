...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.investments_organization =
      await organizations.getInvestments_organization({
        transaction,
      });

    output.startups_organization = await organizations.getStartups_organization(
      {
        transaction,
      },
    );
