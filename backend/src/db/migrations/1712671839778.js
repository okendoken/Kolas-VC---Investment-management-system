module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('startups', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('investments', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('startups', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('startups', 'sector', { transaction });

      await queryInterface.removeColumn('startups', 'name', { transaction });

      await queryInterface.removeColumn('investments', 'investorId', {
        transaction,
      });

      await queryInterface.removeColumn('investments', 'startupId', {
        transaction,
      });

      await queryInterface.removeColumn('investments', 'date', { transaction });

      await queryInterface.removeColumn('investments', 'amount', {
        transaction,
      });
